...
class _WalletState extends State<Wallet> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: wallet == null
          ? Center(child: CircularProgressIndicator())  // Make sure loader is centered
          : Container(
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Your Wallet", style: AppWidget.LightTextFielsStyle()),
                      SizedBox(height: 5.0),
            ...
            Row(
              ...
              children: [
                ...['100', '500', '1000', '2000'].map((amount) => GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text("\$" + amount, style: AppWidget.semiboldTextFieldStyle()),
                  ),
                )).toList()
              ],
            ),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    "Add Money",
                    style: TextStyle(color: Colors.white, fontSize: 16.0, fontFamily: 'Poppins', fontWeight: FontWeight.bold),
                  ),
                ),
              ),
            ),
          ...
          child: Container(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10.0),
                GestureDetector(
                  onTap: () => makePayment(amountcontroller.text),
                  child: Container(
